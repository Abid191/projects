...
document.getElementById('image1').innerText = data[0].imageURL
document.getElementById('name1').innerText = data[0].name
document.getElementById('details1').innerText = data[0].description
document.getElementById('price1').innerText = data[0].price


document.getElementById('image2').innerText = data[1].imageURL
document.getElementById('name2').innerText = data[1].name
document.getElementById('details2').innerText = data[1].description
document.getElementById('price2').innerText = data[1].price
